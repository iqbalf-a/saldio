...
export function guessCategory(description: string): string {
  ...
  const rules: Array<[RegExp, string]> = [
    ...
    [/KOPI|COFFEE|RESTO|WARTEG|FOOD|MCD|KFC|BAKSO|GEPREK|MAKAN/, "Makanan"],
    [/GOJEK|GRAB|GORIDE|MRT|TRANSJAKARTA|KAI|PARKIR|BENSIN|PERTAMINA|SHELL/, "Transportasi"],
    [/ALFAMART|INDOMARET|TOKOPEDIA|SHOPEE|LAZADA|BLIBLI|SUPERMARKET/, "Belanja"],
    [/PLN|LISTRIK|PDAM|BPJS|TELKOM|INDIHOME|INTERNET|TAGIHAN|PULSA|BYU/, "Tagihan"],
    [/NETFLIX|SPOTIFY|DISNEY|VIDIO|CINEMA|CGV|XXI|GAME|STEAM/, "Hiburan"],
    [/TRSF|TRANSFER|BIFAST|BI-FAST|KLIRING|SKN/, "Transfer"],
  ];
