...
export function AddWalletScreen({ navigation }: HomeScreenProps<"AddWallet">) {
  ...
  return (
    <Screen>
      ...
      <Text className="mb-3 font-sans-semibold text-sm text-saldio-soft">Pilih template</Text>
        ...
        {GRID_ORDER.map((key) => {
          ...
          return (
            <Pressable
              ...
              className={`mb-3 w-[48.5%] rounded-2xl bg-white p-4 active:opacity-80 ${
            ...
            >
              ...
              <View className="mt-2 self-start">
                {key === "custom" ? (
                  <View className="rounded-md bg-saldio-bg px-2 py-1">
                    <Text className="font-sans-medium text-[10px] text-saldio-soft">Nama & ikon bebas</Text>
                  </View>
                ) : t.supportsPdfImport ? (
                  <View className="flex-row items-center gap-1 rounded-md bg-saldio-green-bg px-2 py-1">
                    <Ionicons name="document-text" size={10} color="#16A34A" />
                    <Text className="font-sans-medium text-[10px] text-saldio-green">Impor PDF</Text>
                  </View>
                ) : (
                  <View className="rounded-md bg-saldio-bg px-2 py-1">
                    <Text className="font-sans-medium text-[10px] text-saldio-soft">Manual saja</Text>
                  </View>
                )}
              </View>
            </Pressable>
      ...
      <Pressable
        ...
        className={`flex-row items-center gap-3 rounded-2xl bg-saldio-gold-bg p-4 active:opacity-80 ${
      ...
      {/* Detail dompet */}
      <Text className="mb-3 mt-6 font-sans-semibold text-sm text-saldio-soft">Detail dompet</Text>
      <View className="rounded-2xl border-2 border-saldio-blue bg-white px-4 py-3">
        ...
        <TextInput
          ...
          className="mt-1 font-sans-semibold text-base text-saldio-ink"
        />
      </View>
